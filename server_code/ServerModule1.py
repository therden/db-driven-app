...
def decrypt(possible_ciphertext):
  try:
    return anvil.secrets.decrypt_with_key("cryptkeeper", possible_ciphertext)
  # except anvil.secrets.SecretError or anvil.server.InternalError:
  except Exception as e:
    print(e)
    return possible_ciphertext
